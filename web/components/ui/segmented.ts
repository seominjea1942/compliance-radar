 ...
 *
 * White track, black knob. The knob used to be white on a grey track, which
...
export const segmented = {
  track: "flex flex-wrap items-center gap-1 rounded-full border border-line bg-paper p-1",
  item:
